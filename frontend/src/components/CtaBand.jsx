...
export const CtaBand = () => (
  <section className="bg-brand-blue relative overflow-hidden" data-testid="cta-band">
    <div className="absolute inset-0 grid-bg opacity-30" />
    <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-20 md:py-28 relative">
      <Reveal className="max-w-3xl">
        <span className="text-sm uppercase tracking-[0.2em] font-bold text-blue-200">Sin costo · Sin compromiso</span>
        <h2 className="font-display text-4xl md:text-6xl font-black tracking-tighter text-white mt-4 leading-[0.95]">
          Cotiza tu proyecto.<br /> Respuesta en menos de <span className="text-brand-flare">24 horas.</span>
        </h2>
        ...
        <div className="flex flex-wrap gap-4 mt-9">
          <Link to="/contacto" data-testid="ctaband-cotiza" className="rounded-full bg-white text-brand-blue px-8 py-4 font-bold hover:bg-brand-flare hover:text-white transition-colors duration-300">

    ...
    <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-16 md:py-20 grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <div className="flex gap-3">
          <a href={CONTACT.facebook} target="_blank" rel="noopener noreferrer" data-testid="footer-facebook" aria-label="Facebook" className="w-11 h-11 rounded-full border border-slate-700 flex items-center justify-center hover:bg-brand-flare hover:border-brand-flare transition-colors">
